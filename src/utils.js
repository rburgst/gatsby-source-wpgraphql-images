...
const downloadImage = async (
  url,
  { actions, store, cache, reporter, createNodeId, getNodeAndSavePathDependency },
  pathPrefix,
  generateWebp = true,
  httpHeaders = {}
) => {
...
const downloadMediaFile = async ({ url, cache, store, createNode, createNodeId, httpHeaders = {} }) => {
  let fileNode = false
  try {
...
const convertFileNodeToFluid = async ({ generateWebp = true, fileNode, imageOptions, reporter, cache }) => {
...
const copyToStatic = ({ file, getNodeAndSavePathDependency, context, pathPrefix }) => {
